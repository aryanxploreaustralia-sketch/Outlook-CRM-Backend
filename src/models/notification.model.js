...
export const NOTIFICATION_TYPE = Object.freeze({
  ...
  LEAD_SHARING_REVOKED: 'lead_sharing_revoked',
...
export const NOTIFICATION_DEFINITIONS = Object.freeze({
  ...
  [NOTIFICATION_TYPE.LEAD_SHARED]: { label: 'Enquiry shared with you', category: C.INFORMATION },
  [NOTIFICATION_TYPE.LEAD_SHARING_REVOKED]: { label: 'Enquiry access removed', category: C.WARNING },
  [NOTIFICATION_TYPE.LEAD_STAGE_CHANGED]: { label: 'Enquiry status updated', category: C.INFORMATION },
